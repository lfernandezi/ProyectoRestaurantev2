...
public interface DetallePedidoRepository extends JpaRepository<DetallePedido, Integer>{
	...
	+ ":descripcion,:cantidad,:precio)}", nativeQuery = true)
	void ingresarDetallePedido(@Param("codproducto") Integer codproducto , @Param("descripcion") String descripcion, 
			@Param("cantidad") int cantidad,@Param("precio")Double precio);
